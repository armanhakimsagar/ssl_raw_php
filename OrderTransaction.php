...
class OrderTransaction {
    ...
    public function saveTransactionQuery($post_data)
    {
        ...
        $donation_type = $post_data['donation_type'];

        $sql = "INSERT INTO orders (name, email, phone, amount, address, status, transaction_id,currency,donation_type)
                                    VALUES ('$name', '$email', '$phone','$transaction_amount','$address','Pending', '$transaction_id','$currency','$donation_type')";
